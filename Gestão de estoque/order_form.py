...
CTkButton(master=sidebar_frame, image=package_img, text="Orders", fg_color="#fff", font=("Arial Bold", 14), text_color="#387eb8", hover_color="#eee", anchor="w").pack(anchor="center", ipady=5, pady=(16, 0))
